function [c_eq,c] = non_linconstr(X,n_free,nu,nz,d,Ts,Tend,ds_u,Q,R,x_ref,th)
...
% NonLinear inequalities definition
c = [ztemp(1,1) - x_ref(1,1); -ztemp(1,1) + x_ref(2,1)];
% c = [];

% NonLinear equalities definition
c_eq = [zdot];
% c_eq =[];
